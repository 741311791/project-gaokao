...
export default function Footer() {
    return (
        <footer className="bg-white border-t mt-12" data-oid="3wtnvr8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-oid="pkgcp85">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8" data-oid="dtaudp-">
                    <div data-oid="sjjr9zt">
                        <h3 className="text-lg font-semibold mb-4" data-oid="rvs64h.">
                            关于我们
                        </h3>
                        <p className="text-gray-600" data-oid="lhkctyl">
                            河北高考志愿填报服务平台致力于为河北考生提供专业、精准的高考志愿填报服务。
                        </p>
                    </div>
                    <div data-oid="dxtu8uf">
                        <h3 className="text-lg font-semibold mb-4" data-oid="a02-r.o">
                            快速链接
                        </h3>
                        <ul className="space-y-2 text-gray-600" data-oid="2b:d5s8">
                            <li data-oid="4pr6yux">
                                <Link
                                    href="/universities"
                    ...
                    <div data-oid="kyuct38">
                        <h3 className="text-lg font-semibold mb-4" data-oid="vr28xtz">
                            联系方式
                        </h3>
                        <ul className="space-y-2 text-gray-600" data-oid="qfy82rp">
                            <li data-oid="nkfyulw">电话：0311-12345678</li>
                            <li data-oid="e:muils">邮箱：info@hebeivolunteer.com</li>
                            <li data-oid="8fjl9z6">地址：河北省石家庄市桥西区</li>
                        </ul>
                    </div>
                    <div data-oid=".v3bxol">
                        <h3 className="text-lg font-semibold mb-4" data-oid="ds_g3us">
                            关注我们
                        </h3>
                        <div className="flex space-x-4" data-oid="kolt57y">
                            <a
                                href="#"
                                className="text-gray-600 hover:text-blue-600"
                                data-oid="fsizg33"
                            >
                                <span className="sr-only" data-oid="-.b65bs">
                                    微信
                                </span>
                                <svg
                                    className="h-6 w-6"
                            ...
                            <a
                                ...
                                data-oid="2bxhlmt"
                            >
                                <span className="sr-only" data-oid="b33ac8p">
                                    微博
                                </span>
                                <svg
                                    className="h-6 w-6"
                ...
                <div className="border-t mt-8 pt-8 text-center text-gray-500" data-oid="jk9u0g.">
                    <p data-oid="_3n7:y2">© 2023 河北高考志愿填报服务平台 版权所有</p>
                </div>
            </div>
        </footer>
    );
